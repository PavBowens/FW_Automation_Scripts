...
public class finishSaleViaCheque {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test(priority = 1)
	public static void TS_finishSaleViaCheque() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		PageObj.selectChequeOption();
		PageObj.enterChequeDetails("Test Bank","Test Branch","pavithra","1234");
