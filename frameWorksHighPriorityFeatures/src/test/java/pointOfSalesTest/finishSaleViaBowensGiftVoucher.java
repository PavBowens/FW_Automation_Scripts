...
public class finishSaleViaBowensGiftVoucher {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test(priority = 1)
	public static void TS_finishSaleViaBowensGiftVoucher() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		PageObj.enterProductDetails("ASA1003","2","Testing");
		PageObj.tapOnFinishSaleIcon();
		PageObj.tapOnBowensGiftVouchers();
		PageObj.tapOnPayIcon();
		PageObj.enterBowensGiftCardNumber("TestGiftCard","123456");
