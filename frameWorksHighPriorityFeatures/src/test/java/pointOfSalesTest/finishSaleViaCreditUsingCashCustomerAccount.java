...
public class finishSaleViaCreditUsingCashCustomerAccount {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test(priority = 1)
	public static void TS_finishSaleViaCreditUsingCashCustomerAccount() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		PageObj.enterCustomerID("444142");
		PageObj.enterProductDetails("ASA1003","1","Testing");
		PageObj.tapOnFinishSaleIcon();
		PageObj.tapOnTheCreditBalance();
		PageObj.tapOnPayIcon();
		PageObj.tapOnChargeIcon();
		PageObj.enterTheValidOperatorID("686","1234");
	}
