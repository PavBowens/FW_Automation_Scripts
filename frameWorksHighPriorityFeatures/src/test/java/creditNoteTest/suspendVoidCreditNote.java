...
public class suspendVoidCreditNote 
{
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test
	public static void TS_suspendVoidCreditNote() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		CredObj.getCreditNoteNumber();
		CredObj.suspendTheCreditNote();
		CredObj.openTheSuspendedCreditNote(CredObj.getCreditNoteNumber());
//		CredObj.verifyIfAnyErrorIsShown();
		CredObj.voidCreditNote();
	}
