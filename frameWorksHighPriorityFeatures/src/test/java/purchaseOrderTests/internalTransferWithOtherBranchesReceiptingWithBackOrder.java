...
public class internalTransferWithOtherBranchesReceiptingWithBackOrder {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test
	public static void TS_internalTransferWithOtherBranchesReceiptingWithBackOrder() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
...
//		SOObj.editHeader();
		...
		SOObj.updateDateAndTime();
//		SOObj.TapOnThePickerDropDownAndSelectPickerForPO();
		SOObj.enterTheProductsThatNeedsToBePicked("2","3");
		SOObj.confirmTheProducts();
		SOObj.completePickUp ();
		SOObj.checkPickUp();
		SOObj.enterTheBackOrderReasonsForPOc();
		SOObj.clickReleaseOrder();
		SOObj.releaseOrderforYesBackOrderForPurchaseOrder();
	}
