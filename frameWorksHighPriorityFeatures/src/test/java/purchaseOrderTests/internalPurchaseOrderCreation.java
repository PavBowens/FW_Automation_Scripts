...
public class internalPurchaseOrderCreation {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test(priority = 1)
	public static void TS_internalPurchaseOrderCreation() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		POObj.enterTheValidDetailsInThePurchaseOrderForm("Bowen50");
...
//		POObj.tapOnThePurchaseOrderTab();
