...
public class newHardwarePurchaseOrderWithSupplier {
//	SOObj.addHardwareProducts("ASA1003","2");
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test(priority = 1)
	public static void TS_newHardwarePurchaseOrderWithSupplier() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
		...
		POObj.enterTheValidDetailsInThePurchaseOrderForm("BSELLEYS");
		salesOrderPageObjectModal SOObj =new salesOrderPageObjectModal(Driver);
		SOObj.addHardwareProducts("ASA1006","20");
		POObj.editHeader();
