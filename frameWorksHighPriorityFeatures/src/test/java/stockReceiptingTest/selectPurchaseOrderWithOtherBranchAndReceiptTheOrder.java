...
public class selectPurchaseOrderWithOtherBranchAndReceiptTheOrder {
...
//		 please go through the document incase if you are seeing a Old UI or viceversa
	...
	@Test
	public static void TS_selectPurchaseOrderWithOtherBranchAndReceiptTheOrder() {
		pointOfSalesPageObjectModal PageObj = new pointOfSalesPageObjectModal(Driver);
...
//		POObj.tapOnAllBranches();
		...
		POObj.tapOnTheInvoicedFilterHeader();
		POObj.filterTheTypeAsPurchaseOrder();
		POObj.filterTheSupplier("BOWENS");
...
//		POObj.clearAllProductsAndReceiveGoods();
